...
import { useGetDiscussionComments, useCreateDiscussionComment, useGetUserProfile } from '../hooks/useQueries';
...
export default function DiscussionCommentsSection({ postId }: DiscussionCommentsSectionProps) {
  const { identity } = useInternetIdentity();
  const [commentText, setCommentText] = useState('');
  const { data: comments = [], isLoading } = useGetDiscussionComments(postId);
